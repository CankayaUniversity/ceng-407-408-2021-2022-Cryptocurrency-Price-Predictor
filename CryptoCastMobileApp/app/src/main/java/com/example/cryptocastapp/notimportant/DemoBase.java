package com.example.cryptocastapp.notimportant;
...
import com.example.cryptocastapp.charts.Chart;
...
public abstract class DemoBase extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        overridePendingTransition(R.anim.move_left_in_activty, R.anim.move_right_out_activty);
    }
